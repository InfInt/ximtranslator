...
namespace Win32Api
{
    public class RawInput
    {
        ...
        [DllImport("user32.dll")]
        public static extern int GetRawInputData(IntPtr hRawInput, Command uiCommand, out RAWINPUT pData, ref int pcbSize, int cbSizeHeader);
